<?php
// listar_clientes.php
// Página para listar os clientes da agência do gerente com detalhes de conta, agência e banco
...
// Verifica se o gerente está logado e se o ID da agência está definido na sessão.
// Se qualquer um não estiver definido, redireciona para a página de login.
if (!isset($_SESSION['gerente_id']) || !isset($_SESSION['agencia_id'])) {
    header("Location: admin_login.php");
    exit(); // É crucial usar exit() após o header para parar a execução do script.
}
...
<h1 class="mt-4 text-center">Listagem de Clientes da Agência</h1>
